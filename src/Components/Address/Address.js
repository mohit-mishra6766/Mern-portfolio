    ...
    <Container>
          <Row>
           ...
           <h4 >Phone Number</h4> 
              ...
              <p>  <AiOutlineWhatsApp/> +91 9555663127</p>
              </Col>
              <Col md={6} className="contact-address">
              <h4 >Email Address</h4> 
              <p>
                
                <AiOutlineMail/> mohit.mishra2020@vitbhopal.ac.in
              </p>
              </Col>
            ...
            <Col md={12} className="home-about-social">
              ...
              <ul className="home-about-social-links">
                <li className="social-icons">
                  <a
                    href="https://github.com/mohit-mishra6766"
                    target="_blank"
                    rel="noreferrer"
                ...
                <li className="social-icons">
                  <a
                    href="https://github.com/mohit-mishra6766p"
                    target="_blank"
                    rel="noreferrer"
                    className="icon-colour  home-social-icons"
                  >
